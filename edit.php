      ...
      <form action="edit.php?edit_id=<?php echo $row['u_id']; ?>" method="POST" onsubmit="return form()">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <textarea cols="35" rows="2" name="txtadd" id="useraddress"><?php echo $row['u_address']; ?></textarea>
        ...
        <center>
        <div class="button">
          <button type="submit" name="btn-update" onclick="update()" style="background-color: #e7e7e7; border: solid 1px; color:black; padding: 5px 20px; text-decoration: none;margin: 2px 1px; cursor: pointer; Border-radius:5px; Font-size:20px";>Update</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

          <button type="reset" name="btn-reset" style="background-color: #e7e7e7; border: solid 1px; color:black; padding: 5px 20px; text-decoration: none;margin: 2px 1px; cursor: pointer; Border-radius:5px; Font-size:20px";>Reset</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

          <a href="display.php"><button type="button" value="Cancel" style="background-color: #e7e7e7; border: solid 1px; color:black; padding: 5px 20px; text-decoration: none;margin: 2px 1px; cursor: pointer; Border-radius:5px; Font-size:20px";>Cancel</button></a>
        </div>
      </center>
      </form>
